...
Так что, когда современные прикладные программисты используют SQL-интерфейс даже в виде возможности вызова лишь нескольких нужных функций, то у них всё равно останется достаточно много свободы чтобы напортачить:
